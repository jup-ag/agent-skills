...
- description
- confirmation that the paying wallet holds at least 1000 JUP
...
Batch-collect all missing required fields from the API reference, including confirmation that the paying wallet holds at least 1000 JUP.
